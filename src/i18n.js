...
const messages = {
  en: {
    ...
    'auth.captchaCancelled': 'CAPTCHA cancelled. Please try again.',
    'auth.captchaConfig': 'CAPTCHA is not configured. Contact support.',
    'auth.captchaFailed': 'CAPTCHA challenge failed. Please try again.',
    'auth.captchaLoadFailed': 'Human verification could not be loaded. Check your connection and try again.',
    'auth.captchaConfirmTitle': 'Confirm you are human',
    ...
    'common.noGpsCaptured': 'No location captured',
    ...
    'common.close': 'Close',
    'common.internetRequired': 'Internet connection required.',
    'common.signInToReconnect': 'Sign in to reconnect.',
    'common.finishSetup': 'Finish setting up your account.',
    ...
    'home.friendRequests': 'Friend requests',
    'home.friendRequestNote': 'Friend request',
    'home.friendRequestActions': 'Friend request actions',
    'home.friendAccepted': 'Friend accepted',
    'home.recentComments': 'Recent Comments',
    'home.noObservations': 'No observations yet.',
    'home.offlineNoCache': 'Offline — nothing saved on this device yet.',
    ...
    'people.noMatches': 'No matching people',
    'people.noneYet': 'No people yet',
    ...
    'detail.lastMicroscopy': 'Last microscopy',
    'detail.captureTimeUnknown': 'Capture time unknown',
    'detail.identifyInaturalist': 'iNaturalist ID',
    'detail.identifyArtsorakel': 'Artsorakel ID',
    'review.aiId': 'AI Photo ID',
    'review.aiProviderSlow': '{service} is taking longer than usual.',
    'review.aiProviderTimedOut': '{service} timed out. Please try again.',
    'review.aiProviderCancelled': '{service} identification was cancelled.',
    ...
    'detail.loadErrorRetryHint': 'Something went wrong while loading this observation. Please try again later.',
    ...
    'finds.loadingMore': 'Loading more finds…',
    ...
    'finds.pendingWaitingConnection': 'Waiting for connection',
    'finds.pendingWaitingSignIn': 'Sign in to upload',
    'finds.pendingWaitingUpload': 'Waiting to upload',
    'finds.offlineTitle': 'Finds offline',
    'finds.offlineQueuedBody': 'Saved observations on this device are shown below. Reconnect to load your other Finds.',
    'finds.offlineEmptyBody': 'Reconnect to load your Finds. You can still capture new observations while offline.',
    'finds.offlineReauthBody': 'Sign in to load your Finds and upload saved observations.',
    ...
    'profile.sessionExpiredBody': 'Sign in again to sync your observations.',
    'profile.signInAgain': 'Sign in again',
    'auth.reauthNotNow': 'Not now',
    'auth.sessionExpired': 'Session expired',
    'auth.signInAgain': 'Sign in again',
    'home.sessionExpiredBody': 'Sign in again to sync observations and refresh your account.',
    'profile.setupTitle': 'Set up your profile',
    'profile.setupBanner': 'Choose a username and display name to finish creating your account.',
    'profile.setupIncompleteToast': 'Please enter a username and display name to continue.',
    'profile.setupUseAnotherAccount': 'Use another account',
    'profile.setupCompletionFailed': 'Could not finish setup: {message}. Please try again.',
    'profile.setupSignOutFailed': 'Could not sign out: {message}. Please try again.',
    'auth.resolveErrorTitle': 'Could not load your profile',
    'auth.resolveErrorTryAgain': 'Try again',
    'auth.resolveErrorSignOut': 'Sign out',
    ...
    'profile.deleteConfirmTitle': 'Delete this account?',
    ...
    'profile.deleteUnavailable': 'The account-deletion service could not be reached. Please try again.',
  ...
  nb_NO: {
    ...
    'auth.captchaCancelled': 'CAPTCHA ble avbrutt. Prøv igjen.',
    'auth.captchaConfig': 'CAPTCHA er ikke konfigurert. Kontakt support.',
    'auth.captchaFailed': 'CAPTCHA-utfordringen mislyktes. Prøv igjen.',
    'auth.captchaLoadFailed': 'Menneskeverifisering kunne ikke lastes. Sjekk tilkoblingen og prøv igjen.',
    'auth.captchaConfirmTitle': 'Bekreft at du er et menneske',
    ...
    'common.noGpsCaptured': 'Ingen plassering registrert',
    ...
    'common.artsorakelError': 'Artsorakel: {message}',
    'common.close': 'Lukk',
    'common.internetRequired': 'Internett-tilkobling kreves.',
    'common.signInToReconnect': 'Logg inn for å koble til igjen.',
    'common.finishSetup': 'Fullfør oppsett av kontoen din.',
    'home.sporelyCam': 'Sporely Cam',
    ...
    'home.friendRequests': 'Venneforespørsler',
    'home.friendRequestNote': 'Venneforespørsel',
    'home.friendRequestActions': 'Handlinger for venneforespørsel',
    'home.friendAccepted': 'Venn godtatt',
    'home.recentComments': 'Siste kommentarer',
    'home.noObservations': 'Ingen observasjoner ennå.',
    'home.offlineNoCache': 'Frakoblet — ingenting lagret på denne enheten ennå.',
    ...
    'people.noResults': 'Ingen resultater for "{query}"',
    'people.noMatches': 'Ingen personer som matcher',
    'people.noneYet': 'Ingen personer ennå',
    ...
    'detail.species': 'Art',
    'detail.lastMicroscopy': 'Siste mikroskopering',
    'detail.captureTimeUnknown': 'Opptakstidspunkt ukjent',
    'detail.identifyInaturalist': 'iNaturalist ID',
    'detail.identifyArtsorakel': 'Artsorakel ID',
    'review.aiId': 'AI Photo ID',
    'review.aiProviderSlow': '{service} tar lengre tid enn vanlig.',
    'review.aiProviderTimedOut': '{service} brukte for lang tid. Prøv igjen.',
    'review.aiProviderCancelled': '{service}-identifiseringen ble avbrutt.',
    ...
    'detail.loadErrorRetryHint': 'Noe gikk galt under lastingen av denne observasjonen. Prøv igjen senere.',
    ...
    'detail.draftOnlyVisible': 'Bare synlig for deg.',
    'detail.draftWillBePublic': 'Blir offentlig når det publiseres.',
    'detail.draftWillBeFriends': 'Blir synlig for venner når det publiseres.',
    'detail.draftWillBePrivate': 'Privat når det publiseres.',
    'detail.oldDraft': 'Gammelt utkast — se over når du er klar.',
    'detail.staleDraft': 'Foreldet utkast — publiser, behold som utkast, eller slett når du er klar.',
    ...
    'finds.loadingMore': 'Laster flere funn…',
    ...
    'finds.scope': 'Visning',
    'finds.sort': 'Sortering',
    'finds.sortDate': 'Dato',
    'finds.sortSpecies': 'Art',
    'finds.oldDraftBadge': 'Gammelt utkast',
    'finds.staleDraftBadge': 'Foreldet utkast',
    'finds.noFeedFinds': 'Ingen funn i feeden ennå.',
    'finds.noPrivateFinds': 'Ingen private funn ennå.',
    'finds.noPublicFinds': 'Ingen offentlige funn ennå.',
    'scope.followed': 'Fulgte',
    'finds.toast.statusAll': 'Viser utkast og publiserte funn',
    'finds.toast.statusDrafts': 'Viser bare utkast',
    'finds.toast.statusPublished': 'Viser bare publiserte funn',
    'finds.toast.sporesOn': 'Viser funn med sporedata',
    'finds.toast.sporesOff': 'Viser alle funn',
    'finds.toast.sortDate': 'Sortert etter dato',
    'finds.toast.sortSpecies': 'Sortert etter art',
    'finds.toast.mineAll': 'Viser alle funnene dine',
    'finds.toast.minePrivate': 'Viser dine private funn',
    'finds.toast.mineFriends': 'Viser funn delt med venner',
    'finds.toast.minePublic': 'Viser dine offentlige funn',
    'finds.toast.feedAll': 'Viser alle offentlige funn',
    'finds.toast.feedFollowed': 'Viser fulgte arter',
    'finds.toast.feedFriends': 'Viser venner',
    'finds.toast.feedPublic': 'Viser offentlige funn',
    ...
    'finds.pendingWaitingConnection': 'Venter på tilkobling',
    'finds.pendingWaitingSignIn': 'Logg inn for å laste opp',
    'finds.pendingWaitingUpload': 'Venter på opplasting',
    'finds.offlineTitle': 'Funn frakoblet',
    'finds.offlineQueuedBody': 'Observasjoner lagret på denne enheten vises nedenfor. Koble til igjen for å laste inn de andre funnene dine.',
    'finds.offlineEmptyBody': 'Koble til igjen for å laste inn funnene dine. Du kan fortsatt registrere nye observasjoner frakoblet.',
    'finds.offlineReauthBody': 'Logg inn for å laste inn funnene dine og laste opp lagrede observasjoner.',
    ...
    'scope.all': 'Alle',
    'social.friendRequest': 'Send venneforespørsel',
    'social.friendPending': 'Venneforespørsel sendt',
    'social.friendAccepted': 'Venner',
    'social.followUser': 'Følg bruker',
    'social.unfollowUser': 'Slutt å følge bruker',
    'social.followObservation': 'Følg observasjon',
    'social.unfollowObservation': 'Slutt å følge observasjon',
    'social.followTaxon': 'Følg art',
    'social.unfollowTaxon': 'Slutt å følge art',
    'social.followed': 'Følger',
    'social.followButton': 'Følg',
    'social.unfriendUser': 'Fjern venn',
    'social.followFailed': 'Kunne ikke oppdatere følgerstatus.',
    'social.friendFailed': 'Kunne ikke sende venneforespørsel.',
    'profile.title': 'Profil',
    'profile.sessionExpired': 'Økten er utløpt',
    'profile.sessionExpiredBody': 'Logg inn igjen for å synkronisere observasjonene dine.',
    'profile.signInAgain': 'Logg inn igjen',
    'auth.reauthNotNow': 'Ikke nå',
    'auth.sessionExpired': 'Økten er utløpt',
    'auth.signInAgain': 'Logg inn igjen',
    'home.sessionExpiredBody': 'Logg inn igjen for å synkronisere funn og oppdatere kontoen.',
    'profile.setupTitle': 'Sett opp profilen din',
    'profile.setupBanner': 'Velg et brukernavn og visningsnavn for å fullføre opprettelsen av kontoen.',
    'profile.setupIncompleteToast': 'Skriv inn et brukernavn og visningsnavn for å fortsette.',
    'profile.setupUseAnotherAccount': 'Bruk en annen konto',
    'profile.setupCompletionFailed': 'Kunne ikke fullføre oppsettet: {message}. Prøv igjen.',
    'profile.setupSignOutFailed': 'Kunne ikke logge ut: {message}. Prøv igjen.',
    'auth.resolveErrorTitle': 'Kunne ikke laste profilen din',
    'auth.resolveErrorTryAgain': 'Prøv igjen',
    'auth.resolveErrorSignOut': 'Logg ut',
    ...
    'profile.deleteConfirmTitle': 'Slette denne kontoen?',
    ...
    'profile.deleteConfirmButton': 'Slett permanent',
    'profile.deleteCancel': 'Avbryt',
    'profile.deleting': 'Sletter…',
    'profile.deleteUnavailable': 'Tjenesten for kontosletting kunne ikke nås. Prøv igjen.',
  ...
  sv_SE: {
    ...
    'auth.captchaCancelled': 'CAPTCHA avbröts. Försök igen.',
    'auth.captchaConfig': 'CAPTCHA är inte konfigurerat. Kontakta supporten.',
    'auth.captchaFailed': 'CAPTCHA-utmaningen misslyckades. Försök igen.',
    'auth.captchaLoadFailed': 'Mänsklig verifiering kunde inte läsas in. Kontrollera anslutningen och försök igen.',
    'auth.captchaConfirmTitle': 'Bekräfta att du är människa',
    ...
    'common.noGpsCaptured': 'Ingen plats registrerad',
    ...
    'common.artsorakelError': 'Artsorakel: {message}',
    'common.close': 'Stäng',
    'common.internetRequired': 'Internetanslutning krävs.',
    'common.signInToReconnect': 'Logga in för att återansluta.',
    'common.finishSetup': 'Slutför kontoinställningen.',
    'home.sporelyCam': 'Sporely Cam',
    'home.nativeCam': 'Systemkamera',
    'home.webCam': 'Web Cam',
    ...
    'home.friendRequests': 'Vänförfrågningar',
    'home.friendRequestNote': 'Vänförfrågan',
    'home.friendRequestActions': 'Åtgärder för vänförfrågan',
    'home.friendAccepted': 'Vän accepterad',
    'home.recentComments': 'Senaste kommentarer',
    'home.noObservations': 'Inga observationer ännu.',
    'home.offlineNoCache': 'Offline — inget sparat på den här enheten ännu.',
    ...
    'people.noResults': 'Inga resultat för "{query}"',
    'people.noMatches': 'Inga matchande personer',
    'people.noneYet': 'Inga personer ännu',
    ...
    'detail.species': 'Art',
    'detail.lastMicroscopy': 'Senaste mikroskopering',
    'detail.captureTimeUnknown': 'Fotograferingstid okänd',
    'detail.identifyInaturalist': 'iNaturalist ID',
    'detail.identifyArtsorakel': 'Artsorakel ID',
    'review.aiId': 'AI Photo ID',
    'review.aiProviderSlow': '{service} tar längre tid än vanligt.',
    'review.aiProviderTimedOut': '{service} tog för lång tid. Försök igen.',
    'review.aiProviderCancelled': '{service}-identifieringen avbröts.',
    ...
    'detail.loadErrorRetryHint': 'Något gick fel när observationen skulle laddas. Försök igen senare.',
    ...
    'detail.draftOnlyVisible': 'Endast synligt för dig.',
    'detail.draftWillBePublic': 'Blir offentligt när det publiceras.',
    'detail.draftWillBeFriends': 'Blir synligt för vänner när det publiceras.',
    'detail.draftWillBePrivate': 'Privat när det publiceras.',
    'detail.oldDraft': 'Gammalt utkast — gå igenom när du är redo.',
    'detail.staleDraft': 'Inaktuellt utkast — publicera, behåll som utkast eller ta bort när du är redo.',
    ...
    'finds.loadingMore': 'Laddar fler fynd…',
    ...
    'finds.scope': 'Visning',
    'finds.sort': 'Sortering',
    'finds.sortDate': 'Datum',
    'finds.sortSpecies': 'Art',
    'finds.oldDraftBadge': 'Gammalt utkast',
    'finds.staleDraftBadge': 'Inaktuellt utkast',
    'finds.noFeedFinds': 'Inga fynd i flödet ännu.',
    'finds.noPrivateFinds': 'Inga privata fynd ännu.',
    'finds.noPublicFinds': 'Inga offentliga fynd ännu.',
    'scope.followed': 'Följda',
    'finds.toast.statusAll': 'Visar utkast och publicerade fynd',
    'finds.toast.statusDrafts': 'Visar endast utkast',
    'finds.toast.statusPublished': 'Visar endast publicerade fynd',
    'finds.toast.sporesOn': 'Visar fynd med spordata',
    'finds.toast.sporesOff': 'Visar alla fynd',
    'finds.toast.sortDate': 'Sorterat efter datum',
    'finds.toast.sortSpecies': 'Sorterat efter art',
    'finds.toast.mineAll': 'Visar alla dina fynd',
    'finds.toast.minePrivate': 'Visar dina privata fynd',
    'finds.toast.mineFriends': 'Visar fynd delade med vänner',
    'finds.toast.minePublic': 'Visar dina offentliga fynd',
    'finds.toast.feedAll': 'Visar alla offentliga fynd',
    'finds.toast.feedFollowed': 'Visar följda arter',
    'finds.toast.feedFriends': 'Visar vänner',
    'finds.toast.feedPublic': 'Visar offentliga fynd',
    ...
    'finds.pendingWaitingConnection': 'Väntar på anslutning',
    'finds.pendingWaitingSignIn': 'Logga in för att ladda upp',
    'finds.pendingWaitingUpload': 'Väntar på uppladdning',
    'finds.offlineTitle': 'Fynd offline',
    'finds.offlineQueuedBody': 'Observationer sparade på den här enheten visas nedan. Återanslut för att läsa in dina övriga fynd.',
    'finds.offlineEmptyBody': 'Återanslut för att läsa in dina fynd. Du kan fortfarande registrera nya observationer offline.',
    'finds.offlineReauthBody': 'Logga in för att läsa in dina fynd och ladda upp sparade observationer.',
    ...
    'scope.all': 'Alla',
    'social.friendRequest': 'Skicka vänförfrågan',
    'social.friendPending': 'Vänförfrågan skickad',
    'social.friendAccepted': 'Vänner',
    'social.followUser': 'Följ användare',
    'social.unfollowUser': 'Sluta följa användare',
    'social.followObservation': 'Följ observation',
    'social.unfollowObservation': 'Sluta följa observation',
    'social.followTaxon': 'Följ art',
    'social.unfollowTaxon': 'Sluta följa art',
    'social.followed': 'Följer',
    'social.followButton': 'Följ',
    'social.unfriendUser': 'Ta bort vän',
    'social.followFailed': 'Kunde inte uppdatera följstatus.',
    'social.friendFailed': 'Kunde inte skicka vänförfrågan.',
    'profile.title': 'Profil',
    'profile.sessionExpired': 'Sessionen har gått ut',
    'profile.sessionExpiredBody': 'Logga in igen för att synkronisera dina observationer.',
    'profile.signInAgain': 'Logga in igen',
    'auth.reauthNotNow': 'Inte nu',
    'auth.sessionExpired': 'Sessionen har gått ut',
    'auth.signInAgain': 'Logga in igen',
    'home.sessionExpiredBody': 'Logga in igen för att synkronisera fynd och uppdatera kontot.',
    'profile.setupTitle': 'Konfigurera din profil',
    'profile.setupBanner': 'Välj ett användarnamn och visningsnamn för att slutföra ditt konto.',
    'profile.setupIncompleteToast': 'Ange ett användarnamn och visningsnamn för att fortsätta.',
    'profile.setupUseAnotherAccount': 'Använd ett annat konto',
    'profile.setupCompletionFailed': 'Kunde inte slutföra konfigurationen: {message}. Försök igen.',
    'profile.setupSignOutFailed': 'Kunde inte logga ut: {message}. Försök igen.',
    'auth.resolveErrorTitle': 'Kunde inte läsa in din profil',
    'auth.resolveErrorTryAgain': 'Försök igen',
    'auth.resolveErrorSignOut': 'Logga ut',
    ...
    'profile.deleteConfirmTitle': 'Ta bort det här kontot?',
    ...
    'profile.deleteConfirmButton': 'Ta bort permanent',
    'profile.deleteCancel': 'Avbryt',
    'profile.deleting': 'Raderar…',
    'profile.deleteUnavailable': 'Tjänsten för kontoborttagning kunde inte nås. Försök igen.',
  ...
  de_DE: {
    ...
    'auth.captchaCancelled': 'CAPTCHA abgebrochen. Bitte versuche es erneut.',
    'auth.captchaConfig': 'CAPTCHA ist nicht konfiguriert. Kontaktiere den Support.',
    'auth.captchaFailed': 'CAPTCHA-Prüfung fehlgeschlagen. Bitte versuche es erneut.',
    'auth.captchaLoadFailed': 'Die menschliche Verifizierung konnte nicht geladen werden. Prüfe deine Verbindung und versuche es erneut.',
    'auth.captchaConfirmTitle': 'Bestätige, dass du ein Mensch bist',
    ...
    'common.noGpsCaptured': 'Kein Standort erfasst',
    ...
    'common.internetRequired': 'Internetverbindung erforderlich.',
    'common.signInToReconnect': 'Melde dich an, um erneut zu verbinden.',
    'common.finishSetup': 'Schließe die Kontoeinrichtung ab.',
    'home.sporelyCam': 'Sporely Cam',
    ...
    'home.friendRequests': 'Freundschaftsanfragen',
    'home.friendRequestNote': 'Freundschaftsanfrage',
    'home.friendRequestActions': 'Aktionen für Freundschaftsanfrage',
    'home.friendAccepted': 'Freund angenommen',
    'home.recentComments': 'Letzte Kommentare',
    'home.noObservations': 'Noch keine Beobachtungen.',
    'home.offlineNoCache': 'Offline — noch nichts auf diesem Gerät gespeichert.',
    ...
    'people.noResults': 'Keine Ergebnisse für "{query}"',
    'people.noMatches': 'Keine passenden Personen',
    'people.noneYet': 'Noch keine Personen',
    ...
    'detail.species': 'Art',
    'detail.lastMicroscopy': 'Letzte Mikroskopie',
    'detail.captureTimeUnknown': 'Aufnahmezeit unbekannt',
    'detail.identifyInaturalist': 'iNaturalist ID',
    'detail.identifyArtsorakel': 'Artsorakel ID',
    'review.aiId': 'AI Photo ID',
    'review.aiProviderSlow': '{service} braucht länger als gewöhnlich.',
    'review.aiProviderTimedOut': 'Zeitüberschreitung bei {service}. Versuch es erneut.',
    'review.aiProviderCancelled': 'Die {service}-Bestimmung wurde abgebrochen.',
    ...
    'detail.loadErrorRetryHint': 'Beim Laden dieser Beobachtung ist etwas schiefgelaufen. Bitte später erneut versuchen.',
    ...
    'detail.draftOnlyVisible': 'Nur für dich sichtbar.',
    'detail.draftWillBePublic': 'Wird beim Veröffentlichen öffentlich.',
    'detail.draftWillBeFriends': 'Wird beim Veröffentlichen für Freunde sichtbar.',
    'detail.draftWillBePrivate': 'Privat nach dem Veröffentlichen.',
    'detail.oldDraft': 'Alter Entwurf — überprüfe ihn, wenn du bereit bist.',
    'detail.staleDraft': 'Veralteter Entwurf — veröffentlichen, als Entwurf behalten oder löschen, wenn du bereit bist.',
    ...
    'finds.loadingMore': 'Weitere Funde werden geladen…',
    ...
    'finds.scope': 'Ansicht',
    'finds.sort': 'Sortierung',
    'finds.sortDate': 'Datum',
    'finds.sortSpecies': 'Art',
    'finds.oldDraftBadge': 'Alter Entwurf',
    'finds.staleDraftBadge': 'Veralteter Entwurf',
    'finds.noFeedFinds': 'Noch keine Funde im Feed.',
    'finds.noPrivateFinds': 'Noch keine privaten Funde.',
    'finds.noPublicFinds': 'Noch keine öffentlichen Funde.',
    'scope.followed': 'Gefolgt',
    'finds.toast.statusAll': 'Zeige Entwürfe und veröffentlichte Funde',
    'finds.toast.statusDrafts': 'Zeige nur Entwürfe',
    'finds.toast.statusPublished': 'Zeige nur veröffentlichte Funde',
    'finds.toast.sporesOn': 'Zeige Funde mit Sporendaten',
    'finds.toast.sporesOff': 'Zeige alle Funde',
    'finds.toast.sortDate': 'Nach Datum sortiert',
    'finds.toast.sortSpecies': 'Nach Art sortiert',
    'finds.toast.mineAll': 'Zeige alle deine Funde',
    'finds.toast.minePrivate': 'Zeige deine privaten Funde',
    'finds.toast.mineFriends': 'Zeige mit Freunden geteilte Funde',
    'finds.toast.minePublic': 'Zeige deine öffentlichen Funde',
    'finds.toast.feedAll': 'Zeige alle öffentlichen Funde',
    'finds.toast.feedFollowed': 'Zeige gefolgte Arten',
    'finds.toast.feedFriends': 'Zeige Freunde',
    'finds.toast.feedPublic': 'Zeige öffentliche Funde',
    ...
    'finds.pendingWaitingConnection': 'Warten auf Verbindung',
    'finds.pendingWaitingSignIn': 'Zum Hochladen anmelden',
    'finds.pendingWaitingUpload': 'Warten auf Upload',
    'finds.offlineTitle': 'Funde offline',
    'finds.offlineQueuedBody': 'Auf diesem Gerät gespeicherte Beobachtungen werden unten angezeigt. Stelle die Verbindung wieder her, um deine übrigen Funde zu laden.',
    'finds.offlineEmptyBody': 'Stelle die Verbindung wieder her, um deine Funde zu laden. Neue Beobachtungen kannst du auch offline erfassen.',
    'finds.offlineReauthBody': 'Melde dich an, um deine Funde zu laden und gespeicherte Beobachtungen hochzuladen.',
    ...
    'scope.all': 'Alle',
    'social.friendRequest': 'Freundschaftsanfrage senden',
    'social.friendPending': 'Freundschaftsanfrage gesendet',
    'social.friendAccepted': 'Freunde',
    'social.followUser': 'Benutzer folgen',
    'social.unfollowUser': 'Benutzer nicht mehr folgen',
    'social.followObservation': 'Beobachtung folgen',
    'social.unfollowObservation': 'Beobachtung nicht mehr folgen',
    'social.followTaxon': 'Art folgen',
    'social.unfollowTaxon': 'Art nicht mehr folgen',
    'social.followed': 'Folge ich',
    'social.followButton': 'Folgen',
    'social.unfriendUser': 'Freund entfernen',
    'social.followFailed': 'Folgestatus konnte nicht aktualisiert werden.',
    'social.friendFailed': 'Freundschaftsanfrage konnte nicht gesendet werden.',
    'profile.title': 'Profil',
    'profile.sessionExpired': 'Sitzung abgelaufen',
    'profile.sessionExpiredBody': 'Melde dich erneut an, um deine Beobachtungen zu synchronisieren.',
    'profile.signInAgain': 'Erneut anmelden',
    'auth.reauthNotNow': 'Nicht jetzt',
    'auth.sessionExpired': 'Sitzung abgelaufen',
    'auth.signInAgain': 'Erneut anmelden',
    'home.sessionExpiredBody': 'Melde dich erneut an, um Funde zu synchronisieren und dein Konto zu aktualisieren.',
    'profile.setupTitle': 'Richte dein Profil ein',
    'profile.setupBanner': 'Wähle einen Benutzernamen und Anzeigenamen, um dein Konto fertigzustellen.',
    'profile.setupIncompleteToast': 'Gib einen Benutzernamen und Anzeigenamen ein, um fortzufahren.',
    'profile.setupUseAnotherAccount': 'Anderes Konto verwenden',
    'profile.setupCompletionFailed': 'Einrichtung konnte nicht abgeschlossen werden: {message}. Bitte versuche es erneut.',
    'profile.setupSignOutFailed': 'Abmelden fehlgeschlagen: {message}. Bitte versuche es erneut.',
    'auth.resolveErrorTitle': 'Dein Profil konnte nicht geladen werden',
    'auth.resolveErrorTryAgain': 'Erneut versuchen',
    'auth.resolveErrorSignOut': 'Abmelden',
    ...
    'profile.deleteConfirmTitle': 'Dieses Konto löschen?',
    ...
    'profile.deleteUnavailable': 'Der Kontolöschdienst war nicht erreichbar. Bitte versuche es erneut.',
