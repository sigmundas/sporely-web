...
const messages = {
  en: {
    ...
    'review.aiId': 'AI Photo ID',
    'review.resultsOutdated': 'Results outdated',
    ...
    'import.heicBrowserUnsupported': 'HEIC/HEIF import is not supported in the desktop browser. Use the installed app or import JPG, PNG, or WebP instead.',
    'import.setFromGps': 'Set from GPS',
    'import.aiIdAll': 'ID All',
    'import.photoIdBy': 'Photo ID by {service}',
  ...
  nb_NO: {
    ...
    'detail.identifyArtsorakel': 'Artsorakel ID',
    'review.aiId': 'AI Photo ID',
    'review.resultsOutdated': 'Resultatene er utdaterte',
    ...
    'import.heicBrowserUnsupported': 'HEIC/HEIF-import støttes ikke i nettleseren på skrivebordet. Bruk den installerte appen eller importer JPG, PNG eller WebP i stedet.',
  ...
  sv_SE: {
    ...
    'detail.identifyArtsorakel': 'Artsorakel ID',
    'review.aiId': 'AI Photo ID',
    'review.resultsOutdated': 'Resultaten är föråldrade',
    ...
    'import.heicBrowserUnsupported': 'HEIC/HEIF-import stöds inte i skrivbordswebbläsaren. Använd den installerade appen eller importera JPG, PNG eller WebP i stället.',
  ...
  de_DE: {
    ...
    'detail.identifyArtsorakel': 'Artsorakel ID',
    'review.aiId': 'AI Photo ID',
    'review.resultsOutdated': 'Ergebnisse sind veraltet',
    ...
    'import.heicBrowserUnsupported': 'HEIC/HEIF-Import wird im Desktop-Browser nicht unterstützt. Bitte nutze die installierte App oder importiere stattdessen JPG, PNG oder WebP.',
