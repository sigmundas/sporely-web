...
const messages = {
  en: {
    ...
    'review.noMatch': 'No match found',
    'review.aiUnavailable': 'Artsorakel unavailable — CORS blocked. Needs a proxy.',
    ...
    'review.syncing': 'Syncing to Sporely Cloud…',
    'review.synced': 'Synced 1 observation with {count} ✓',
    'review.syncFailed': 'Sync failed: {message}',
    ...
    'import.failedOneGroup': 'Failed to save one group. Others may have saved.',
    'import.saved': 'Saved {count}',
  ...
  nb_NO: {
    ...
    'review.noMatch': 'Ingen treff funnet',
    'review.aiUnavailable': 'Artsorakel er utilgjengelig — CORS er blokkert. Trenger en proxy.',
    ...
    'review.syncing': 'Synkroniserer til Sporely Cloud…',
    'review.synced': 'Synkroniserte 1 observasjon med {count} ✓',
    'review.syncFailed': 'Synkronisering feilet: {message}',
    ...
    'import.failedOneGroup': 'Kunne ikke lagre én gruppe. Andre kan ha blitt lagret.',
    'import.saved': 'Lagret {count}',
  ...
  sv_SE: {
    ...
    'review.noMatch': 'Ingen träff hittades',
    'review.aiUnavailable': 'Artsorakel är inte tillgängligt — CORS blockeras. En proxy behövs.',
    ...
    'review.syncing': 'Synkar till Sporely Cloud…',
    'review.synced': 'Synkade 1 observation med {count} ✓',
    'review.syncFailed': 'Synk misslyckades: {message}',
    'detail.backHome': 'Hem',
    ...
    'import.failedOneGroup': 'Det gick inte att spara en grupp. Andra kan ha sparats.',
    'import.saved': 'Sparade {count}',
  ...
  de_DE: {
    ...
    'review.noMatch': 'Kein Treffer gefunden',
    'review.aiUnavailable': 'Artsorakel nicht verfügbar — CORS blockiert. Ein Proxy wird benötigt.',
    ...
    'review.syncing': 'Synchronisiere mit Sporely Cloud…',
    'review.synced': '1 Beobachtung mit {count} synchronisiert ✓',
    'review.syncFailed': 'Synchronisierung fehlgeschlagen: {message}',
    ...
    'import.failedOneGroup': 'Eine Gruppe konnte nicht gespeichert werden. Andere wurden möglicherweise gespeichert.',
    'import.saved': '{count} gespeichert',
...
export function applyStaticTranslations() {
  ...
  setText('#screen-profile .field-meta-header', 'profile.connection')
  setText('#screen-profile .field-meta-key', 'profile.supabase')
