...
const messages = {
  en: {
    ...
    'profile.sent': 'Sent',
    'profile.add': 'Add',
    'profile.cloudPlan': 'Cloud plan',
    'profile.cloudStorage': 'Cloud storage',
    'profile.planTier': 'Tier',
    'profile.uploads': 'Uploads',
    'profile.storage': 'Storage',
    'profile.planFree': 'Free',
    'profile.planPro': 'Pro',
    'profile.uploadReduced': 'Reduced (2 MP)',
    'profile.uploadFull': 'Full resolution',
    'profile.storageUnknown': 'Not tracked yet',
    'profile.storageUsedOnly': '{used} used',
    'profile.storageUsedOfQuota': '{used} / {total}',
    'profile.cloudPlanFreeNote': 'Cloud uploads are reduced for now to keep hosting costs predictable.',
    'profile.cloudPlanProNote': 'This account is marked ready for full-resolution cloud backups.',
    'profile.cloudPlanDebugOverride': 'Testing override active: {mode}. Set it back to Server when you want the real account state.',
    ...
    'settings.min': 'min',
    'settings.photoGapHint': 'Photos taken within this window are grouped into one observation.',
    'settings.testing': 'Testing',
    'settings.testingHint': 'Local-only override for testing free vs paid cloud behavior.',
    'settings.overrideServer': 'Server',
    'settings.overrideFree': 'Free',
    'settings.overridePro': 'Pro',
    'settings.testingEnabled': 'Testing overrides enabled',
    'settings.testingHidden': 'Testing overrides hidden',
  ...
  nb_NO: {
    ...
    'profile.connection': 'Tilkobling',
    'profile.supabase': 'Supabase',
    'profile.checking': 'Sjekker…',
    ...
    'profile.connected': 'Tilkoblet',
    'profile.offline': 'Frakoblet',
    ...
    'profile.cloudPlan': 'Skyplan',
    'profile.cloudStorage': 'Skylagring',
    'profile.planTier': 'Nivå',
    'profile.uploads': 'Opplastinger',
    'profile.storage': 'Lagring',
    'profile.planFree': 'Gratis',
    'profile.planPro': 'Pro',
    'profile.uploadReduced': 'Redusert (2 MP)',
    'profile.uploadFull': 'Full oppløsning',
    'profile.storageUnknown': 'Ikke sporet ennå',
    'profile.storageUsedOnly': '{used} brukt',
    'profile.storageUsedOfQuota': '{used} / {total}',
    'profile.cloudPlanFreeNote': 'Skyopplastinger reduseres foreløpig for å holde hostingkostnadene forutsigbare.',
    'profile.cloudPlanProNote': 'Denne kontoen er merket som klar for fulloppløselige skybackup-er.',
    'profile.cloudPlanDebugOverride': 'Testing-overstyring aktiv: {mode}. Sett den tilbake til Server når du vil bruke den ekte kontotilstanden.',
    ...
    'settings.min': 'min',
    'settings.photoGapHint': 'Bilder tatt innenfor dette tidsrommet grupperes til én observasjon.',
    'settings.testing': 'Testing',
    'settings.testingHint': 'Lokal overstyring for testing av gratis vs betalt skyadferd.',
    'settings.overrideServer': 'Server',
    'settings.overrideFree': 'Gratis',
    'settings.overridePro': 'Pro',
    'settings.testingEnabled': 'Testing-overstyringer aktivert',
    'settings.testingHidden': 'Testing-overstyringer skjult',
  ...
  sv_SE: {
    ...
    'profile.connection': 'Anslutning',
    'profile.supabase': 'Supabase',
    'profile.checking': 'Kontrollerar…',
    ...
    'profile.cloudPlan': 'Molnplan',
    'profile.cloudStorage': 'Molnlagring',
    'profile.planTier': 'Nivå',
    'profile.uploads': 'Uppladdningar',
    'profile.storage': 'Lagring',
    'profile.planFree': 'Gratis',
    'profile.planPro': 'Pro',
    'profile.uploadReduced': 'Reducerad (2 MP)',
    'profile.uploadFull': 'Full upplösning',
    'profile.storageUnknown': 'Inte spårat ännu',
    'profile.storageUsedOnly': '{used} använt',
    'profile.storageUsedOfQuota': '{used} / {total}',
    'profile.cloudPlanFreeNote': 'Molnuppladdningar reduceras tills vidare för att hålla hostingkostnaderna förutsägbara.',
    'profile.cloudPlanProNote': 'Det här kontot är markerat som redo för fullupplösta molnbackup-er.',
    'profile.cloudPlanDebugOverride': 'Testöverstyrning aktiv: {mode}. Sätt tillbaka den till Server när du vill använda det riktiga kontoläget.',
    ...
    'settings.min': 'min',
    'settings.photoGapHint': 'Bilder tagna inom detta tidsfönster grupperas till en observation.',
    'settings.testing': 'Testning',
    'settings.testingHint': 'Lokal överstyrning för att testa gratis kontra betalt molnbeteende.',
    'settings.overrideServer': 'Server',
    'settings.overrideFree': 'Gratis',
    'settings.overridePro': 'Pro',
    'settings.testingEnabled': 'Testöverstyrningar aktiverade',
    'settings.testingHidden': 'Testöverstyrningar dolda',
  ...
  de_DE: {
    ...
    'profile.cloudPlan': 'Cloud-Tarif',
    'profile.cloudStorage': 'Cloud-Speicher',
    'profile.planTier': 'Stufe',
    'profile.uploads': 'Uploads',
    'profile.storage': 'Speicher',
    'profile.planFree': 'Kostenlos',
    'profile.planPro': 'Pro',
    'profile.uploadReduced': 'Reduziert (2 MP)',
    'profile.uploadFull': 'Volle Auflösung',
    'profile.storageUnknown': 'Noch nicht erfasst',
    'profile.storageUsedOnly': '{used} genutzt',
    'profile.storageUsedOfQuota': '{used} / {total}',
    'profile.cloudPlanFreeNote': 'Cloud-Uploads werden vorerst reduziert, damit die Hosting-Kosten planbar bleiben.',
    'profile.cloudPlanProNote': 'Dieses Konto ist für Cloud-Backups in voller Auflösung vorbereitet.',
    'profile.cloudPlanDebugOverride': 'Test-Override aktiv: {mode}. Stelle es auf Server zurück, wenn du den echten Kontostatus verwenden willst.',
    ...
    'settings.min': 'min',
    'settings.photoGapHint': 'Fotos innerhalb dieses Zeitfensters werden zu einer Beobachtung gruppiert.',
    'settings.testing': 'Tests',
    'settings.testingHint': 'Lokale Übersteuerung zum Testen von kostenlosem vs. bezahltem Cloud-Verhalten.',
    'settings.overrideServer': 'Server',
    'settings.overrideFree': 'Kostenlos',
    'settings.overridePro': 'Pro',
    'settings.testingEnabled': 'Test-Overrides aktiviert',
    'settings.testingHidden': 'Test-Overrides ausgeblendet',
...
export function applyStaticTranslations() {
  ...
  setText('#profile-stat-finds-label', 'stats.finds')
  setText('#profile-stat-species-label', 'stats.species')
  setText('#profile-stat-friends-label', 'stats.friends')
  setAllText('#screen-profile .profile-section-title', [
    t('profile.addFriend'),
  ...
  setText('#profile-cloud-plan-key', 'profile.planTier')
  ...
  setText('#profile-connection-header', 'profile.connection')
  setText('#profile-connection-key', 'profile.supabase')
  setText('#profile-sync-status', 'profile.checking')
  ...
  setText('#settings-debug-label', 'settings.testing')
  setText('#settings-debug-hint', 'settings.testingHint')
  setText('#settings-cloud-plan-server', 'settings.overrideServer')
  setText('#settings-cloud-plan-free', 'settings.overrideFree')
  setText('#settings-cloud-plan-pro', 'settings.overridePro')
