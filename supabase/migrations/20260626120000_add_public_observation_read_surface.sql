-- Public explorer read surface for anonymous browsing.
--
-- Exposes only privacy-safe observation fields for the first public explorer
-- surface: public observations without images, raw coordinates, storage paths,
-- or spore points.
-- Microscopy signals only count active, non-deleted, non-purged microscope
-- image rows.
